...
```typescript
// shared/lib/contexts/ThemeContext.tsx
...
import { FeatureFlagsContext } from '@/shared/lib/contexts/FeatureFlagsContext'
...
```typescript
// features/auth/lib/contexts/AuthContext.tsx
...
import { AuthProvider } from '@/features/auth/lib/contexts/AuthContext'
import { QueryProvider } from '@/shared/lib/contexts/QueryContext'
...
```typescript
// features/cart/lib/contexts/CartContext.tsx
