---
name: react-developer-v19
description: React 19.2 features and component patterns - use(), useOptimistic, useActionState, useEffectEvent, Activity component, React Compiler, custom hooks, composition patterns, lazy loading, virtualization, error boundaries. Use when implementing React 19 patterns or general React component patterns.
version: 19.2.0
user-invocable: true
