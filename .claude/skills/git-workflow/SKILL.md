---
name: git-workflow
description: Reference doc for Git workflow patterns. Usually linked from other skills rather than invoked directly. Covers branching strategies, commit conventions, merge vs rebase, conflict resolution, and collaborative development best practices for teams of all sizes.
origin: ECC
---
