...
```typescript
import { useCounterStore } from '@/shared/lib/stores/counter.store'
...
```typescript
// shared/lib/stores/app.store.ts
...
```typescript
// shared/lib/stores/mouse.store.ts
import { create } from 'zustand'
...
```typescript
// shared/lib/stores/sync/local-storage.ts
...
```typescript
// shared/lib/stores/sync/analytics.ts
...
```typescript
// shared/lib/stores/sync/websocket.ts
...
```typescript
// shared/lib/hooks/use-store-subscription.ts
