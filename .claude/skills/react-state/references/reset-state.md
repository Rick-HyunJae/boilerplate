...
```typescript
// shared/lib/stores/counter.store.ts
...
```typescript
// shared/lib/stores/reset-stores.ts
...
```typescript
// shared/lib/stores/settings.store.ts
import { create } from 'zustand'
...
```typescript
// shared/lib/create-store-with-reset.ts
...
import { resetAllStores } from '@/shared/lib/stores/reset-stores'
