...
```typescript
// shared/lib/stores/__tests__/setup.ts
...
```typescript
// shared/lib/stores/__tests__/counter.store.test.ts
...
```typescript
// shared/ui/__tests__/Counter.test.tsx
import { describe, it, expect, beforeEach } from 'vitest'
...
```typescript
// features/auth/model/__mocks__/user.store.ts
...
```typescript
// features/auth/model/__tests__/user.store.test.ts
