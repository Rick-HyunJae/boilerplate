...
2. **Integration Tests** — API endpoints, data operations
...
Run Lighthouse or equivalent against meaningful pages. Keep CWV targets from [performance.md](performance.md).

## Cross-Browser

Minimum: Chrome, Firefox, Safari. Test scrolling, motion, and fallback behavior.

## Responsive

Test widths: 320, 375, 768, 1024, 1440, 1920. Verify no overflow. Verify touch interactions.
...
- `test-driven-development` — Red-Green-Refactor cycle, write-tests-first enforcement
- `react-testing` — RTL queries, userEvent, MSW, Vitest config
